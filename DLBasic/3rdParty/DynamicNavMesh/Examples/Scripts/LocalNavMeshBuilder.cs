...
public class LocalNavMeshBuilder : MonoBehaviour
{
    ...
    public Vector3 m_Size = new Vector3(150, 20.0f, 100);
    ...
    //[SerializeField,Range(0,180)] float MaxSlope=45f;
    ...
    void UpdateNavMesh(bool asyncUpdate = false)
    {
        ...
        //defaultBuildSettings.agentSlope = MaxSlope;
        //defaultBuildSettings.agentClimb = StepHeight;
