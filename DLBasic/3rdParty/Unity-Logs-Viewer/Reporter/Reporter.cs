...
{
    public static Reporter Ins = null;
            ...
            Application.platform == RuntimePlatform.IPhonePlayer)
        {
            ...
            else
            {
                ...
                else if (Input.touches[0].phase == TouchPhase.Moved)
                {
                    ...
                    if (gestureDetector.Count == 0 || (p - gestureDetector[gestureDetector.Count - 1]).magnitude > 160)
    ...
    void AddLog(string condition, string stacktrace, LogType type)
    {
        ...
        {
            clear();
            Debug.Log(string.Format("Memory Usage Reach{0} mb So It is Cleared", maxSize));
            return;
        }
